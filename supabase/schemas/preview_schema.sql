...
--
-- Name: image_insert_data; Type: TYPE; Schema: public; Owner: -
--
...
--
-- Name: insert_images(public.image_insert_data[]); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.insert_images(image_data public.image_insert_data[]) RETURNS SETOF uuid
    LANGUAGE plpgsql SECURITY DEFINER
...
--
-- Name: FUNCTION insert_images(image_data public.image_insert_data[]); Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON FUNCTION public.insert_images(image_data public.image_insert_data[]) IS 'Inserts multiple images with automatic timestamp handling and returns their IDs';
...
--
-- Name: idx_images_post_id; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_posts_date; Type: INDEX; Schema: public; Owner: -
--
